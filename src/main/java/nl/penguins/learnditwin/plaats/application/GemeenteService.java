...
public class GemeenteService {
    ...
    public GemeenteDTO getAlleBuurtenVanGemeente(String gemeenteNaam) {
        ...
        return new GemeenteDTO(gemeenteRepository.findByNaam(gemeenteNaamHoofdletter)
                .orElseThrow(() -> new GemeenteNotFoundException(String.format("Gemeente met naam %s niet gevonden", gemeenteNaamHoofdletter))));
    }
}
